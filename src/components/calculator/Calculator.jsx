        ...
        <div className='calculator-container'>
            ...
            >
                <FormControl fullWidth sx={{ m: 1, width: '35ch' }}>
                    <InputLabel htmlFor="outlined-adornment-amount" color="warning">Nro de Envios</InputLabel>
                    <OutlinedInput
                ...
                <FormControl fullWidth sx={{ m: 1, width: '35ch' }}>
                    <InputLabel htmlFor="outlined-adornment-amount" color="warning">Costo de Envio</InputLabel>
                    <OutlinedInput
                        id="outlined-adornment-amount"
                ...
                <FormControl fullWidth sx={{ m: 1, width: '35ch' }}>
                    <InputLabel htmlFor="outlined-adornment-amount" color="warning">Efectivo del Cadete</InputLabel>
                    <OutlinedInput
                        id="outlined-adornment-amount"
                        startAdornment={<InputAdornment position="start">$</InputAdornment>}
                ...
                <FormControl fullWidth sx={{ m: 1, width: '35ch' }}>
                    <InputLabel htmlFor="outlined-adornment-amount" color="warning">Total Efectivo</InputLabel>
                    <OutlinedInput
                        id="outlined-adornment-amount"
                        startAdornment={<InputAdornment position="start">$</InputAdornment>}
